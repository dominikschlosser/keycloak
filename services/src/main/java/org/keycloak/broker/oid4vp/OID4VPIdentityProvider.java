...
public class OID4VPIdentityProvider extends AbstractIdentityProvider<OID4VPIdentityProviderConfig> {
    ...
    static final String DIRECT_POST_RESULT_PREFIX = "oid4vp.direct-post.";
    static final String ENTRY_JSON = "json";
    static final String STATIC_SUBJECT = "oid4vp-static-subject";
    ...
    public Response performLogin(AuthenticationRequest request) {
        ...
        URI walletUri = URI.create(OID4VPConstants.WALLET_AUTHORIZATION_SCHEME
                + "?client_id=" + clientId
    ...
    OID4VPAuthorizationRequest createAuthorizationRequest(String clientId, String state, String responseUri) {
